...
function drawDonut() {
	...
	var low=parseInt(riskada.Low);
	var medium=parseInt(riskada.Medium);
	var high=parseInt(riskada.High);
    // Data
    var data = google.visualization.arrayToDataTable([
        ['Task', 'Hours per Day'],
        ['Low',     low],
...
function drawPie() {
	...
	var n=parseInt(stageData.NEW);
	var ongoing=parseInt(stageData.ONGOING);
	var onhold=parseInt(stageData.ONHOLD);
	var cancelled=parseInt(stageData.CANCELLED);
	var completed=parseInt(stageData.COMPLETED);
